...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header"> <span class="logo"></span> <span class="version">${SCRIPT_VERSION}</span> </div>
		<!-- /.navbar-header -->
		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<!-- END IF -->
					<!-- IF '${ACCOUNT_ROLE}' == 'admin' -->
					<li><a	<!-- IF '${ACTIVE_MENU}' == 'update' -->class="active"	<!-- END IF -->	href="./?t=update" title="${MENU_UPDATE_TITLE}"><i class="fa fa-refresh"></i> ${MENU_UPDATE}</a> </li>
					<!-- END IF -->
