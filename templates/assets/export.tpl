...
<form action="${ACTION}" target=_blank method="post">
  ...
  <div class="form-group">
    ...
    <div class="radio">
      <label>
        <input type="radio" value="1" checked name="export_type"> ${STR_EXPORT_TEXT}
      </label>

      <label>
        <input type="radio" value="2" name="export_type"> ${STR_EXPORT_EXCEL}
      </label>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="radio">
      <label>
        <input type="radio" checked value="1" name="zip"> ${STR_COMPRESSION_OPTION_1}
      </label>

      <label>
        <input type="radio" value="2" name="zip"> ${STR_COMPRESSION_OPTION_2}
      </label>
